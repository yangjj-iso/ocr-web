...
export const cancelDevDashboardTask = (taskId) => devDashboardApi.post(`${taskPath(taskId)}/cancel`)
export const deleteDevDashboardTask = (taskId) => devDashboardApi.delete(taskPath(taskId))
export const getDevDashboardBatches = () => devDashboardApi.get('/batches')
